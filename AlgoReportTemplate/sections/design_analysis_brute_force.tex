...
\begin{algorithm}[H]
    ...
    \SetKwFunction{FBDistanciaEdicion}{FBDistanciaEdicion}  % Cambia 'AlgorithmName' por el nombre del enfoque elegido
    ...
    \myproc{\FBDistanciaEdicion{S1, S2}}{
    \uIf{S1 está vacía}{
    ...
    \uElseIf{S1[0] = S2[0]}{
        \Return \FBDistanciaEdicion{S1[1:], S2[1:]}  % Llamada recursiva
    }
    \Else{
    ...
    \Else{
        ...
        \Return \FBDistanciaEdicion{S1 modificado, S2}\;  % Llamada recursiva y retorno del resultado
    }
    }
    \caption{Prueba}
